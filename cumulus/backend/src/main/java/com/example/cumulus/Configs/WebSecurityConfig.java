    ...
    public SecurityWebFilterChain securityWebFilterChain(ServerHttpSecurity http) {
        return http
                ...
                .authorizeExchange(exchange -> exchange
                        ...
                        .pathMatchers(
                                "api/session/authenticate", "/logout", "/api/session/refresh-token", "/api/signup", "/contactus", "/api/loggedin/user",
                                "api/test/getgptresponse", "api/assess-workstream", "api/test/initialiseResources", "/api/test/getrequest", "/api/contactus/sendemail"
                        ).permitAll()
